...
def main(req: func.HttpRequest, cosmos: func.DocumentList) -> str:
    ...
    mydict = {
        "id":cosmos[0]['id'],
        "timestamp": cosmos[0]['timestamp'],
        "userId": cosmos[0]['userId'],
        "productId": cosmos[0]['productId'],
        "locationName": cosmos[0]['locationName'],
        "rating": cosmos[0]['rating'],
        "userNotes": cosmos[0]['userNotes']
    }
